...
public class Res extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "10004", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg/microservice-10004/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  @ApiOperation(value = "postSongs", notes = " ")
  public Response postSongs(String payload) {
