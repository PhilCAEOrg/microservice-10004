 ...
 * 10004 - Test Class
 *
 * This class provides a basic testing framework for the microservice 10004. It was
...
public class ResTest {
  ...
  /**
   * 
   * Test for the postSongs method.
   * 
   */
  @Test
  public void testpostSongs() {
    ...
    try {
      ...
      System.out.println("Result of 'testpostSongs': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
